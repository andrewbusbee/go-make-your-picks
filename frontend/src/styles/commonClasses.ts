...
// ============================================================================
// HISTORICAL CHAMPIONS MANAGEMENT
// ============================================================================

// Historical champions table container
export const historicalChampionsTableClasses = 
  "w-full border border-gray-300 dark:border-gray-600 rounded-md overflow-hidden";

// Historical champions table header
export const historicalChampionsTableHeaderClasses = 
  "bg-gray-50 dark:bg-gray-800 border-b border-gray-300 dark:border-gray-600";

// Historical champions table header row
export const historicalChampionsTableHeaderRowClasses = 
  "grid grid-cols-12 gap-4 p-4 text-sm font-medium text-gray-700 dark:text-gray-300";

// Historical champions table body
export const historicalChampionsTableBodyClasses = 
  "bg-white dark:bg-gray-900 divide-y divide-gray-300 dark:divide-gray-600";

// Historical champions table row
export const historicalChampionsTableRowClasses = 
  "grid grid-cols-12 gap-4 p-4 text-sm text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-800";

// Historical champions table cell classes
export const historicalChampionsNameCellClasses = 
  "col-span-5 font-medium";

export const historicalChampionsYearCellClasses = 
  "col-span-3 text-gray-600 dark:text-gray-400";

export const historicalChampionsActionsCellClasses = 
  "col-span-4 flex gap-2";

// Historical champions action buttons
export const historicalChampionsEditButtonClasses = 
  "text-xs py-1 px-2 rounded transition font-medium bg-blue-100 hover:bg-blue-200 text-blue-800 dark:bg-blue-900 dark:hover:bg-blue-800 dark:text-blue-200";

export const historicalChampionsDeleteButtonClasses = 
  "text-xs py-1 px-2 rounded transition font-medium bg-red-100 hover:bg-red-200 text-red-800 dark:bg-red-900 dark:hover:bg-red-800 dark:text-red-200";

// Historical champions add button
export const historicalChampionsAddButtonClasses = 
  "mb-4 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white rounded-md transition font-medium flex items-center gap-2";

// Historical champions modal classes
export const historicalChampionsModalClasses = 
  "fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50";

export const historicalChampionsModalContentClasses = 
  "bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-md w-full mx-4";

export const historicalChampionsModalHeaderClasses = 
  "px-6 py-4 border-b border-gray-300 dark:border-gray-600";

export const historicalChampionsModalBodyClasses = 
  "px-6 py-4 space-y-4";

export const historicalChampionsModalFooterClasses = 
  "px-6 py-4 border-t border-gray-300 dark:border-gray-600 flex justify-end gap-3";

// Historical champions form classes
export const historicalChampionsFormGroupClasses = 
  "space-y-2";

export const historicalChampionsLabelClasses = 
  "block text-sm font-medium text-gray-700 dark:text-gray-300";

export const historicalChampionsInputClasses = 
  "w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-md bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500";

export const historicalChampionsErrorClasses = 
  "text-sm text-red-600 dark:text-red-400";

// Historical champions empty state
export const historicalChampionsEmptyStateClasses = 
